  ...
  return (
    <PageLayout>
      <SectionBlock>
        ...
        <li>
        <p><strong>Website</strong> refers to Insightful IR, accessible from <a href="https://www.getinsightfulir.com" rel="external nofollow noopener noreferrer" target="_blank">https://www.getinsightfulir.com</a></p>
        </li>
        <li>
